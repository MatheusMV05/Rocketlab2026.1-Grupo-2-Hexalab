...
const ROTULOS: { chave: keyof LimitesBloco; label: string }[] = [
...
export function PainelLimitesBloco({ limites, onAplicar }: Props) {
  ...
  return (
    <div className="bg-white border border-[#e0e0e0] rounded-[5px] shadow-md p-3 min-w-[220px]">
      <p className="text-[11px] font-semibold text-[#1d5358] mb-3">Produtos por quadrante</p>
